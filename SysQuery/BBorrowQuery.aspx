...
<table width="771" height="465" border="0" align="center" cellpadding="0" cellspacing="1" class="waikuang">
        <tr><form name="form1" method="post" action="">
          <td valign="top"><table width="756" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="45" colspan="3" background="../images/qicaizujiechaxun.gif">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td colspan="3" valign="top" background="../images/qicaizujie pai hang2.gif" style="height: 246px">                
                ...
                <tr>
                  <td height="5" colspan="2"><table width="720" height="30" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#B7B6B6" bordercolordark="#FFFFFF">
                    ...
                    <asp:ListItem>租借时间</asp:ListItem>
                </asp:DropDownList>&nbsp; 
                ...
                <asp:GridView ID="gvBorrowInfo" runat="server" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" Font-Size="9pt" OnPageIndexChanging="gvBorrowInfo_PageIndexChanging" Width="678px" HorizontalAlign="Center">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="borrowTime" HeaderText="租借时间" />
